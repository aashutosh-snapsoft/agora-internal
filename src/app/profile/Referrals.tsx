...
import CheckMarkCircleOutlined from "@/components/icons/CheckMarkCircleOutlined";
// COMMON STYLED COMPONENTS
import { BodyTableCellV2, BodyTableRow, HeadTableCell } from "./common/styles";
// CUSTOM UTILS METHOD
import { format } from "@/lib/utils/currency";
    ...
    <Card sx={{ pb: 2 }}>
      ...
      <Box padding={3}>
        ...
        <Alert
          ...
          variant="outlined"
          icon={<Info />}
          action={<Button>Withdraw $44,550</Button>}
        >
          <AlertTitle>We Need Your Attention</AlertTitle>
          Writing headlines for blog posts is as much an art as it is a science,
          and warrants its own post, but for now, all I’d advise is
          experimenting what works for your audience, especially if it’s not
      ...
      {/* REFFED USERS TABLE */}
      <FlexBetween px={3} pb={2} component="div">
          ...
          <TableBody>
            {REFER_LIST.map((item) => (
              <BodyTableRow key={item.orderId}>
                ...
                <BodyTableCellV2 sx={{ color: "success.main" }}>
