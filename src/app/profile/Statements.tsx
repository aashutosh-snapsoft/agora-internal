...
import DownloadTo from "@/components/icons/DownloadTo";
import ReceiptOutlined from "@/components/icons/ReceiptOutlined";
import ChartDonut from "@/components/icons/sidebar/ChartDonutIcon";
  ...
  return (
    <Card sx={{ pb: 2 }}>
      ...
      <Box padding={3}>
        ...
        <EarningBoxWrapper flexWrap="wrap" pt={2} component="div">
          <StyledStack direction="row" flexWrap="wrap" spacing={2}>
            {EARNING_LIST.map(({ id, Icon, amount, iconColor, name }) => (
              <EarningBox key={id}>
      ...
      <FlexBetween px={3} py={2} component="div">
