...
import NotificationAlert from "@/components/icons/NotificationAlert";
    ...
    <Card>
      ...
      <Box padding={3}>
        ...
        <Alert severity="info" variant="outlined" icon={<NotificationAlert />}>
          ...
          Adds an extra layer of security to your account. To log in, in you&apos;ll
          need to provide a 4 digit amazing and create outstanding products to
          serve your clients <Link href="#">Learn More</Link>.
        </Alert>
      </Box>
          ...
          <TableBody>
            {keys.map((item, index) => (
              <BodyTableRow key={index}>
                ...
                <BodyTableCellV2>
                  <FlexBox alignItems="center" component="div">
