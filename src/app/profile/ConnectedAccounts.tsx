    ...
    <Card sx={{ pb: 2 }}>
      <Box padding={3}>
        ...
        <Small color="text.secondary">
          Two-factor authentication adds to log in, in you&apos;ll need to
          provide a 4 digit amazing code. <Link href="#">Learn More</Link>
        </Small>
      </Box>

      <Divider />

      {ACCOUNT_LIST.map(({ id, title, body, image }) => (
        <FlexBetween
          key={id}
          component="div"
          sx={{
        ...
        >
          <FlexBox alignItems="center" gap={2} component="div">
            <Avatar src={image} />
