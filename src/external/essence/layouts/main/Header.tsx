...
import { FlexBetween, FlexBox } from "@/external/essence/components/flexbox";
// CUSTOM ICON COMPONENT
import ChevronDown from "@/external/essence/icons/ChevronDown";
// NAVIGATION LIST
...
const Header = () => {
  ...
  const LARGE_DEVICE_CONTENT = (
    <FlexBox sx={LIST_STYLE} component="nav">
      <Box
        component={Link}
        href="/"
      ...
      <Box component={Link} href="http://essence-doc.vercel.app" color="text.primary">
        Documentation
      </Box>
